...
JNIEXPORT jlong JNICALL Java_org_ws2811_Ws2811Library_init(JNIEnv * env,
							   jclass jc,
							   jint frequency,
							   jint dmanum,
							   jobjectArray channels) {
...
JNIEXPORT jint JNICALL Java_org_ws2811_Ws2811Library_render(JNIEnv * env,
                jclass jc, jlong reference, jint channel, jintArray jleds) {
  ws2811_t *ledstring = (ws2811_t*) ((long)reference);
...
JNIEXPORT jint JNICALL Java_org_ws2811_Ws2811Library_waitCompletion(
                JNIEnv * env, jclass jc, jlong reference) {
  ws2811_t *ledstring = (ws2811_t*) ((long)reference);
